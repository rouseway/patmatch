package com.github.rouseway.nlp.patmatch.test;
...
import com.github.rouseway.nlp.patmatch.engine.InformationExtractor;
import com.github.rouseway.nlp.patmatch.engine.PatternMatch;
...
public class Test {
	public static void main(String[] args) {
		...
		String destStr = "����֧������2016/01/03�ɹ�����10000Ԫ";
		...
		//String destStr = "����2016��11��14�ճɹ�����1000Ԫ";
